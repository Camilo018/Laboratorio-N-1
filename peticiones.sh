...
validationFunction(){
   ...
   then
      ...
      sshpass -p "12345" ssh -o StrictHostKeyChecking=no kamil018@192.168.0.119 'cd git_environment;cd Laboratorio-N-1;pm2 stop laboratorio-n1;git pull;pm2 start laboratorio-n1'
   fi
}
